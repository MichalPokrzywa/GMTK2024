...
namespace Verpha.HierarchyDesigner
{
    ...
    public class HierarchyDesigner_Visual_Separator
    {
        ...
        struct TextStyleKey
        {
            ...
            {
                int hashCode = 17;
                hashCode = hashCode * 23 + TextColor.GetHashCode();
                hashCode = hashCode * 23 + FontStyle.GetHashCode();
                hashCode = hashCode * 23 + FontSize.GetHashCode();
                hashCode = hashCode * 23 + TextAlignment.GetHashCode();
                return hashCode;
            }
        }
        #endregion
        ...
        private static void DrawSeparator(GameObject gameObject, Rect selectionRect)
        {
            ...
            {
                separatorInfo = new HierarchyDesigner_Info_Separator(
                    "Separator",
                    defaultTextColor,
